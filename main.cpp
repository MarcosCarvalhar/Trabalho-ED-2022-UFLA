...
// Retorna 1 caso o primeiro registro informado for maior que o segundo, e o segundo, caso contrário.
int fncComparaRegistro(PayrollSaoFrancisco _TMPREGISTRO1, PayrollSaoFrancisco _TMPREGISTRO2)
{
	...
	{
		return 1;
	} else if (_TMPREGISTRO1.cJobTitle < _TMPREGISTRO2.cJobTitle)
	{
		return 2;
	} else
	{
...
int main()
{
    ...
    while(iOpcao != 0)
    {
		...
		cout << "7 - Ordenar arquivo binário" << endl; // OK
		cout << "=============================================================" << endl;
